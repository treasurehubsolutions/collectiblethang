...
export const metadata = {
  title: 'Born2BeToys – Toys & Collectibles Cheap | Hot Wheels, Star Wars, Marvel, Discount',
  ...
  keywords: 'cheap toys, discount collectibles, toy liquidation, trending toys, hot wheels, star wars, marvel, dc comics, transformers, lego, action figures, funko pop, diecast, vintage toys, Quebec Canada, born2betoys, deals, cheap, toy store canada',
  openGraph: {
    title: 'Born2BeToys – Discount Toys & Collectibles Quebec Canada',
    description: 'Toy liquidation and collectibles. Hot Wheels, Star Wars, Marvel, DC, Transformers and more. Ships Canada & USA.',
      ...
      <div style={{maxWidth:1300,margin:'0 auto',display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))',gap:40,marginBottom:40}}>
        <div>
          ...
          <div style={{fontSize:12,color:'#555',lineHeight:1.9}}>
            Discount toys & collectibles shop<br/>
        ...
        <div>
          ...
          <div style={{fontSize:12,color:'#555',lineHeight:2.1}}>
            ...
            ↩️ 30-day return policy accepted
          </div>
        </div>
      </div>
