    ...
    <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:40}}>
      ...
      <div>
        ...
        <button onClick={handleAdd}
          style={{width:'100%',background:added?'#166534':'#e8b820',color:added?'#86efac':'#000',border:'none',borderRadius:8,padding:'16px',fontWeight:800,fontSize:16,cursor:'pointer',transition:'all .2s',letterSpacing:.3,marginBottom:10}}>
