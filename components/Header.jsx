...
export default function Header() {
  ...
  return (
    <>
      {/* Top bar */}
      <div style={{background:'linear-gradient(90deg,#cc1100,#7c22e8)',color:'#fff',textAlign:'center',padding:'6px 12px',fontSize:11,fontWeight:700,letterSpacing:'.3px'}}>
        <div style={{display:'flex',alignItems:'center',justifyContent:'center',gap:0,flexWrap:'wrap'}}>
          ...
          <span style={{display:'inline-flex',alignItems:'center',gap:5}}>
            <img src="/qc-flag.png" alt="Québec" style={{width:20,height:14,borderRadius:2,objectFit:'cover'}}/>
            Fièrement Québécois
          </span>
        </div>
      </div>
        ...
        <div style={{maxWidth:1300,margin:'0 auto',padding:'0 20px',height:62,display:'flex',alignItems:'center',gap:16}}>
          ...
          <div style={{marginLeft:'auto',display:'flex',alignItems:'center',gap:8,flexShrink:0}}>
            ...
            >
              🛒 {tx.cart}
              {count > 0 && (
                <span style={{background:'rgba(255,255,255,.2)',borderRadius:20,padding:'1px 7px',fontSize:11,fontWeight:700}}>
                  {count}
                </span>
              )}
            </button>
