      ...
      <header style={{background:'#0d0d12',borderBottom:'1px solid #1c1c28',position:'sticky',top:0,zIndex:200}}>
        <div style={{maxWidth:1300,margin:'0 auto',padding:'0 20px',height:58,display:'flex',alignItems:'center',gap:16}}>
          ...
          <div style={{marginLeft:'auto',display:'flex',alignItems:'center',gap:8,flexShrink:0}}>
            <a href="https://www.ebay.com/str/collectiblethang" target="_blank"
              style={{fontSize:12,color:'#555',textDecoration:'none',padding:'6px 10px',border:'1px solid #1c1c28',borderRadius:6}}>
              eBay ↗
            </a>
        ...
        <div style={{background:'#0a0a14',borderTop:'1px solid #1a1a28',overflowX:'auto'}}>
          <div style={{maxWidth:1300,margin:'0 auto',padding:'0 20px',display:'flex',alignItems:'center'}}>
            <Link href="/shop"
              style={{padding:'9px 14px',fontSize:12,color:'#aaa',textDecoration:'none',borderRight:'1px solid #1a1a28',whiteSpace:'nowrap',fontWeight:700}}>
              Tout voir
            </Link>
            ...
            <Link href="/shop?sort=popular"
              style={{padding:'9px 13px',fontSize:12,color:'#e8b820',textDecoration:'none',whiteSpace:'nowrap',fontWeight:700}}>
              🔥 Populaires
            </Link>
          </div>
        </div>
