...
export default function HomeClient() {
  ...
  return (
    <div>
      {/* HERO */}
      <div style={{background:'linear-gradient(180deg,#12121e 0%,#0d0d12 100%)',borderBottom:'2px solid #e8b820',overflow:'hidden'}}>
        <div style={{maxWidth:1300,margin:'0 auto',padding:'48px 24px 42px'}}>
